...
export const leadColumnsV3: ColumnDef<Lead>[] = [
    {
        accessorKey: 'name',
    ...
    {
        accessorKey: 'form',
        header: () => <div className="w-full font-medium">Form name</div>,
        cell: ({ row }) => <div className="font-medium">{row.original.form.name}</div>,
        enableSorting: false,
    },
    {
        accessorKey: 'broker',
